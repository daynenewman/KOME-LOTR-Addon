...
public class MumakilAnchoredHiredInteractGui extends LOTRGuiHiredInteract {
    private final LOTREntityNPC driver;
    private final LOTREntityMumakil mumakil;

    public MumakilAnchoredHiredInteractGui(LOTREntityNPC driver, LOTREntityMumakil mumakil) {
        super(driver);
        this.driver = driver;
