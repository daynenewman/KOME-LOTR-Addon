...
public class MumakilAnchoredHiredWarriorGui extends LOTRGuiHiredWarrior {
    private final LOTREntityNPC driver;
    private final LOTREntityMumakil mumakil;

    public MumakilAnchoredHiredWarriorGui(LOTREntityNPC driver, LOTREntityMumakil mumakil) {
        super(driver);
        this.driver = driver;
    ...
    public void updateScreen() {
        if (!MumakilHiredDriverGuiContext.canAnchor(
                this.driver,
                this.mumakil,
                MumakilHiredDriverGuiAccess.HIRED_COMMAND_DISTANCE_SQ)) {
