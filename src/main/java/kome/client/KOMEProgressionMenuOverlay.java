...
public class KOMEProgressionMenuOverlay {
    ...
    public void onInitGui(GuiScreenEvent.InitGuiEvent.Post event) {
        ...
        event.buttonList.add(new KOMEGuiButtonMenuTile((LOTRGuiMenu) event.gui, 4, x + 84, y, kome.client.gui.KOMEGuiAllianceUnified.class, "KOME Alliances", "allianceimage.png"));
