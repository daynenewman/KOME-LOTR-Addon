...
public class KOMEGuiRelationshipHub extends LOTRGuiMenuBase {
 ...
 public void initGui(){xSize=220;ySize=150;super.initGui();buttonList.clear();buttonMenuReturn=null;int c=width/2;buttonList.add(KOMEGuiButton.wide(0,c-72,guiTop+90,"Talk"));buttonList.add(KOMEGuiButton.wide(1,c-72,guiTop+114,"Service"));}
 ...
 public void actionPerformed(GuiButton b){if(!b.enabled)return;KOMEPacketHandler.network.sendToServer(new KOMEPacketRelationshipAction(id,type,b.id==0?KOMEPacketRelationshipAction.TALK:KOMEPacketRelationshipAction.SERVICE));mc.displayGuiScreen(null);}
}
